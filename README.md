...
4. Python 3.10+ (all versions above are supported)
   ...
   **Installation Paths:** If you're on Windows or macOS, proceed with the manual installation. macOS users also have the option to use the [DMG installation file](../../releases) for a quicker setup.

   
**To install the program on your machine, follow these instructions:**
1. Install the program on your machine.
```bash
git clone https://github.com/ura-vf4/crypto-tax-calculator
```
2. Setup the program.
```bash
...
- [ ] [potentially many others](https://github.com/ura-vf4/crypto-tax-calculator/)
